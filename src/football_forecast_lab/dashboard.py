...
<head>
  ...
  <style>
    ...
    td:nth-child(3), td:nth-child(n+4) {{ font-variant-numeric: tabular-nums; }}
...
<main>
  ...
  <table>
    <thead><tr><th>Date</th><th>Match</th><th>Score</th><th>Exact</th><th>Home</th><th>Nul</th><th>Away</th></tr></thead>
